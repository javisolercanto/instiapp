  ...
  <section class="market">
    ...
    <section class="market__filters shadow">
      <section class="market__filters__wrapper">
        ...
        <select v-model="data.filters.location" @change="listGroups()" 
      ...
      <section class="market__filters__wrapper">
        ...
        <select v-model="data.selectedOrder" @change="listGroups()"
      ...
      <section class="market__filters__wrapper  market__filters__wrapper--horizontal">
        <label class="market__filters__price__label" for="price">Show my groups:</label>
        <input
    ...
    <Fab @click.native="$router.push({name: 'group-creator'})" :type="FabTypeEnum.ADD" />
...
import store, { storeTypes, Group, Location, User } from "../../store";
...
export default class Groups extends Vue {
  ...
  mounted() {
    window.addEventListener("resize", this.refreshGroupsSize);
    this.refreshGroupsSize();
  ...
  listGroups(): void {
    ...
    GroupService.list(this.data.filters)
      .then(res => {
        this.data.groups = res.data.data;
