  ...
  <section class="market">
    ...
    <section class="market__filters shadow">
      <section class="market__filters__wrapper">
        ...
        <select v-model="data.filters.category" @change="listProducts()" 
          class="input" name="category" id="category">
      ...
      <section class="market__filters__wrapper">
        ...
        <select v-model="data.selectedOrder" @change="listProducts()"
    ...
    <Fab @click.native="$router.push({name: 'product-creator'})" :type="FabTypeEnum.ADD" />
...
import store, { storeTypes, Product, Category } from "../../store";
...
export default class Products extends Vue {
  ...
  mounted() {
    window.addEventListener("resize", this.refreshProductsSize);
    this.refreshProductsSize();
